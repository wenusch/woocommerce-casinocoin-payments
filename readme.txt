...
== Installation ==
Download the [latest version](https://github.com/empatogen/woocommerce-xrp/archive/master.zip) and unpack in your wp-content/plugins folder. Go to "WooCommerce -> Settings -> Payments" and setup the plugin.

...
== Installation ==
Download the [latest release](https://github.com/empatogen/woocommerce-xrp/archive/v1.0.1.zip) and unpack in your wp-content/plugins folder. Go to "WooCommerce -> Settings -> Payments" and setup the plugin.
